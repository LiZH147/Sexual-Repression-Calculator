      ...
      <Card className="sri-card">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t('assessment:consent.formTitle')}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-2">{t('assessment:consent.sections.purpose.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('assessment:consent.sections.purpose.description')}
                </p>
              </div>
            </div>
            <div className="ml-8">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <Checkbox 
                  ...
                  className="mt-1"
                />
                <span>{t('assessment:consent.sections.purpose.agreement')}</span>
              </label>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-2">{t('assessment:consent.sections.privacy.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('assessment:consent.sections.privacy.description')}
                </p>
              </div>
            </div>
            <div className="ml-8">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <Checkbox 
                  ...
                  className="mt-1"
                />
                <span>{t('assessment:consent.sections.privacy.agreement')}</span>
              </label>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-2">{t('assessment:consent.sections.voluntary.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('assessment:consent.sections.voluntary.description')}
                </p>
              </div>
            </div>
            <div className="ml-8">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <Checkbox 
                  ...
                  className="mt-1"
                />
                <span>{t('assessment:consent.sections.voluntary.agreement')}</span>
              </label>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-2">{t('assessment:consent.sections.nonDiagnostic.title')}</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {t('assessment:consent.sections.nonDiagnostic.description')}
                </p>
              </div>
            </div>
            <div className="ml-8">
              <label className="flex items-start gap-2 text-sm cursor-pointer">
                <Checkbox 
                  ...
                  className="mt-1"
                />
                <span>{t('assessment:consent.sections.nonDiagnostic.agreement')}</span>
              </label>
            </div>
          </div>
            ...
            <>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-psychology-warning">{t('assessment:consent.sections.minorProtection.title')}</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {t('assessment:consent.sections.minorProtection.description')}
                    </p>
                  </div>
                </div>
                <div className="ml-8 space-y-2">
                  <label className="flex items-start gap-2 text-sm cursor-pointer">
                    <Checkbox 
                      ...
                      className="mt-1"
                    />
                    <span>{t('assessment:consent.sections.minorProtection.ageConfirmation')}</span>
                  </label>
                  <label className="flex items-start gap-2 text-sm cursor-pointer">
                    <Checkbox 
                      ...
                      className="mt-1"
                    />
                    <span>{t('assessment:consent.sections.minorProtection.parentalConsent')}</span>
                  </label>
                </div>
              </div>
              ...
              <Alert className="border-psychology-warning">
                ...
                <AlertDescription className="text-sm">
                  <strong>{t('assessment:consent.alerts.minorReminder')}</strong>
                </AlertDescription>
              </Alert>
            </>
          )}
          ...
          <Alert>
            ...
            <AlertDescription className="text-sm">
              <strong>{t('assessment:consent.alerts.importantReminder')}</strong>
            </AlertDescription>
          </Alert>
          ...
          <div className="flex justify-between pt-4 border-t">
            {onBack && (
              <Button variant="outline" onClick={onBack}>
                {t('assessment:consent.buttons.back')}
              </Button>
            )}
            <div className="flex gap-3 ml-auto">
              ...
              >
                {t('assessment:consent.buttons.disagree')}
              </Button>
              <Button 
              ...
              >
                {t('assessment:consent.buttons.agree')}
              </Button>
            </div>
          </div>
        </CardContent>
